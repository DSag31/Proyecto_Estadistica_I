install.packages(c("arrow", "dplyr", "ggplot2","sf"))
library(arrow)
...
# 1. Leer el archivo Parquet de Desapariciones
df_hom <- read_parquet("C:/Datos_limpios/datos_filtrados_Desapariciones.parquet") 
